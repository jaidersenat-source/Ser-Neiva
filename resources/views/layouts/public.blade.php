...
<nav class="sirn-nav" role="navigation" aria-label="Navegación principal">
    ...
    <div class="leading-tight">
        ...
        <div class="flex items-center gap-3 flex-shrink-0">
            ...
            @auth
                {{-- Usuario autenticado --}}
                {{-- Mostrar enlace al panel administrativo sólo para admins --}}
                ...
                @elseif(auth()->user()->isIglesia())
                    {{-- Usuario iglesia: muestra su nombre y enlace a su portal --}}
                    <div class="hidden sm:flex items-center gap-2 text-blue-300">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                    ...
                    <a href="{{ route('iglesia.dashboard') }}" class="btn-admin" aria-label="Ir a mi portal de iglesia">
