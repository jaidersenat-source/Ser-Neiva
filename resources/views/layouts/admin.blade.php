    ...
    <nav id="sidebar-nav" aria-label="Navegación principal">
        ...
        <a href="{{ route('admin.iglesias.index') }}"
           class="nav-item {{ request()->routeIs('admin.iglesias.index') || request()->routeIs('admin.iglesias.show', 'admin.iglesias.create', 'admin.iglesias.edit', 'admin.iglesias.store', 'admin.iglesias.update', 'admin.iglesias.destroy') ? 'active' : '' }}">
            ...
            Iglesias
            @php $totalIglesias = \App\Models\Iglesia::count(); @endphp
            @if($totalIglesias > 0)
                <span class="nav-badge">{{ $totalIglesias }}</span>
            @endif
        </a>
        ...
        {{-- Emprendimientos --}} 
         <a href="{{ route('admin.emprendimientos.index') }}"
           class="nav-item {{ request()->routeIs('admin.emprendimientos.index') || request()->routeIs('admin.emprendimientos.show', 'admin.emprendimientos.create', 'admin.emprendimientos.edit') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
