...
<div class="relative mb-6 rounded-2xl overflow-hidden"
    ...
    <div class="relative z-10 px-6 py-5 sm:px-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-2 flex-shrink-0 ml-14 sm:ml-0">
            @php
                $showRoute = null;
                if (\Illuminate\Support\Facades\Route::has('iglesia.perfil.show')) {
                    $showRoute = route('iglesia.perfil.show', $iglesia);
                } elseif (\Illuminate\Support\Facades\Route::has('admin.iglesias.show')) {
                    $showRoute = route('admin.iglesias.show', $iglesia);
                } else {
                    $showRoute = '#';
                }
            @endphp
...
<div class="max-w-4xl">
        <form action="{{ route('iglesia.perfil.update') }}" method="POST"
        ...
        <div class="sticky bottom-0 z-20 mt-6 -mx-4 sm:mx-0 sm:relative sm:bottom-auto
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <button type="submit"
                  ...
                  <a href="{{ route('iglesia.perfil.show', $iglesia) }}"
