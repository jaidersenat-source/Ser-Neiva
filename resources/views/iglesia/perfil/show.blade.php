        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5">
            ...
            <div class="flex sm:flex-col items-center sm:items-end gap-3 flex-shrink-0">
                ...
                <div class="flex gap-2">
                          <a href="{{ route('iglesia.perfil.edit') }}"
            ...
            <div class="p-4 space-y-3">
                @if($linkedUser)
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('iglesia.perfil.edit') }}" class="text-xs font-semibold px-3 py-2 rounded-lg bg-violet-50 text-violet-700 border border-violet-100">
                            Editar credenciales
                        </a>
                    </div>
                ...
                @else
                    ...
                    <a href="{{ route('iglesia.perfil.edit') }}" class="inline-flex items-center gap-2 text-xs font-semibold px-3 py-2 rounded-lg bg-violet-50 text-violet-700 border border-violet-100">
                        Crear credenciales
                    </a>
                @endif
            </div>
