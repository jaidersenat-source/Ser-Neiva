        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5">
            ...
            <div class="flex sm:flex-col items-center sm:items-end gap-3 flex-shrink-0">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.emprendimientos.edit', $emprendimiento) }}" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold transition-all hover:opacity-95"
                       style="background:#ffffff;color:#065f46;border:1px solid rgba(6,95,70,0.08);box-shadow:0 6px 18px rgba(6,95,70,0.06);">
                        Editar
                    </a>
                    <a href="{{ route('admin.emprendimientos.index') }}" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold transition-all hover:opacity-95"
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="rounded-2xl p-4" style="background:#FFF1F2; border:1px solid #FECDD3;">
            ...
            <form method="POST" action="{{ route('admin.emprendimientos.destroy', $emprendimiento) }}" class="form-eliminar-show" data-nombre="{{ addslashes($emprendimiento->nombre) }}">
                @csrf @method('DELETE')
